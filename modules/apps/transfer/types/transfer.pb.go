...
type Params struct {
	...
	SlashPrefix string `protobuf:"bytes,3,opt,name=slash_prefix,json=slashPrefix,proto3" json:"slash_prefix,omitempty" yaml:"slash_prefix"`
}
...
func (m *Params) GetSlashPrefix() string {
	if m != nil {
		return m.SlashPrefix
	}
	return ""
}
...
var fileDescriptor_5041673e96e97901 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SlashPrefix) > 0 {
		i -= len(m.SlashPrefix)
		copy(dAtA[i:], m.SlashPrefix)
		i = encodeVarintTransfer(dAtA, i, uint64(len(m.SlashPrefix)))
		i--
		dAtA[i] = 0x1a
	}
	if m.ReceiveEnabled {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlashPrefix", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SlashPrefix = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTransfer(dAtA[iNdEx:])
